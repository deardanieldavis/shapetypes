...
test('closestPoint: Returns correct point', t => {
  t.true(t.context.angled.closestPoint(new Point(6,8)).equals(new Point(6,8)));
});
test('closestPoint: Returns correct point depending on if onlyPositive or not', t => {
  t.true(t.context.angled.closestPoint(new Point(0,0)).equals(new Point(0,0)));
  t.true(t.context.angled.closestPoint(new Point(0,0), false).equals(new Point(0,0)));
  t.true(t.context.angled.closestPoint(new Point(0,0), true).equals(new Point(3,4)));
});
